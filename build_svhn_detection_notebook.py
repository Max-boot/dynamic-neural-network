"""
Erzeugt SVHN_Detektionsbeispiele.ipynb - zeigt nach dem SVHN-Training/Messen
10 zufaellige Test-Szenen mit Detektions-Boxen INLINE im Notebook an.

Laden der SVHN-Modelle + scene_dataset_svhn, Lauf der vollen Pipeline
(hybrid2, gate=0.2), Anzeige GT (gruen) vs. Pipeline (rot, Klasse+Konfidenz).
"""
import json
import os

HERE = os.path.dirname(os.path.abspath(__file__))
OUT = os.path.join(HERE, "SVHN_Detektionsbeispiele.ipynb")
